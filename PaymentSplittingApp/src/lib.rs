...
pub const MAX_GROUP_NUM: usize = 1600;
pub const DPF_DOMAIN: usize = 15; // 9 = 2^8 = 256 // about 60 AES evals
pub const SETTLE_DOMAIN: usize = 12; // 9 = 2^8 = 256 // about 60 AES evals
pub const SETTLE_SIZE: usize = 309;
